...
class Widget extends \App\Controllers\BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->model_appearance_layout = new \Main\Marketplace\Models\Appearance\Layout_Model();
    }
    ...
    public function get($widget_id)
    {
        ...
        if ($widget_info) {
            if ($widget_info['author'] == 'com_openmvm') {
                $namespace = '\Main\Marketplace\Controllers\Appearance\Marketplace\Widgets\\' . $widget_info['widget'];
