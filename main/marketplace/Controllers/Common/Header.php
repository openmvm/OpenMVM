...
class Header extends \App\Controllers\BaseController
{
    ...
    public function index($header_params = array())
    {
        ...
        $data['my_downloads'] = $this->url->customerLink('marketplace/account/product_download', '', true);
        ...
        $data['seller_product_question'] = $this->url->customerLink('marketplace/seller/product_question', '', true);
        $data['seller_faq'] = $this->url->customerLink('marketplace/seller/seller_faq', '', true);
