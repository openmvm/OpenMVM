    ...
    public function edit()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            if (!$this->administrator->hasPermission('modify', 'Page/Page')) {
                ...
                return redirect()->to($this->url->administratorLink(env('app.adminUrlSegment') . '/page/page/edit/' . $this->uri->getSegment($this->uri->getTotalSegments())));
            }
            ...
            if ($this->validation->withRequest($this->request)->run()) {
                ...
                return redirect()->to($this->url->administratorLink(env('app.adminUrlSegment') . '/page/page'));
            } else {
                // Errors
