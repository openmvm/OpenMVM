...
namespace Main\Admin\Controllers\Appearance\Admin;
...
class Theme extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        foreach ($themes as $theme) {
            ...
            if ($extension_info) {
                ...
                $info = file_get_contents($this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/admin/theme/' . strtolower($theme_author) . '/' . strtolower($theme_name) . '/get_info'));
            ...
            $data['themes'][] = [
                ...
                'theme_image' => $image,
                'link' => $link,
                'href' => $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/admin/theme/' . strtolower($theme_author) . '/' . strtolower($theme_name)),
                'activated' => $activated,
                'activate' => $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/admin/theme/activate', ['theme' => $theme_author . ':' . $theme_name]),
                'deactivate' => $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/admin/theme/deactivate', ['theme' => $theme_author . ':' . $theme_name]),
                'set' => $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/admin/theme/set_admin_theme', ['theme' => $theme_author . ':' . $theme_name]),
                'remove' => $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/admin/theme/remove', ['theme' => $theme_author . ':' . $theme_name]),
            ];
        }
    ...
    public function set_admin_theme()
    {
        ...
        if (!$this->administrator->hasPermission('access', 'Appearance/Admin/Theme')) {
            ...
            return redirect()->to(env('app.adminUrlSegment') . '/appearance/admin/theme?administrator_token=' . $this->request->getGet('administrator_token'));
        }
