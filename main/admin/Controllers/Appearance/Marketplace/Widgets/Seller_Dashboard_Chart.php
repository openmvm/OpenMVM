...
class Seller_Dashboard_Chart extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widget/Seller_Dashboard_Chart/save/' . $this->uri->getSegment($this->uri->getTotalSegments()));
    ...
    public function get_form($data)
    {
        ...
        $data['breadcrumbs'][] = array(
            'text' => lang('Text.seller_dashboard_chart'),
            'href' => $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widgets/seller_dashboard_chart'),
            'active' => true,
        );

        $data['heading_title'] = lang('Heading.seller_dashboard_chart');
        ...
        // Header
        $header_params = array(
            'title' => lang('Heading.seller_dashboard_chart'),
        );
        ...
        $template_setting = [
            ...
            'permission' => 'Appearance/Marketplace/Widgets/Seller_Dashboard_Chart',
            'override' => false,
        ];
    ...
    public function save()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            if (!$this->administrator->hasPermission('modify', 'Appearance/Marketplace/Widgets/Seller_Dashboard_Chart')) {
