...
class Seller_Featured_Product extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widget/Seller_Featured_Product/save/' . $this->uri->getSegment($this->uri->getTotalSegments()));
    ...
    public function get_form($data)
    {
        ...
        $data['breadcrumbs'][] = array(
            'text' => lang('Text.seller_featured_products'),
            'href' => $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widgets/seller_featured_product'),
            'active' => true,
        );

        $data['heading_title'] = lang('Heading.seller_featured_products');
        ...
        // Header
        $header_params = array(
            'title' => lang('Heading.seller_featured_products'),
        );
        ...
        $template_setting = [
            ...
            'author' => 'com_openmvm',
            'theme' => 'Basic',
            'view' => 'Appearance\Marketplace\Widgets\seller_featured_product',
            'permission' => 'Appearance/Marketplace/Widgets/Seller_Featured_Product',
            'override' => false,
        ];
    ...
    public function save()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            if (!$this->administrator->hasPermission('modify', 'Appearance/Marketplace/Widgets/Seller_Featured_Product')) {
