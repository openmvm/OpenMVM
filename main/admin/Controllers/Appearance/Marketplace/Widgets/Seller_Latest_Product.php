...
class Seller_Latest_Product extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widget/Seller_Latest_Product/save/' . $this->uri->getSegment($this->uri->getTotalSegments()));
    ...
    public function get_form($data)
    {
        ...
        $data['breadcrumbs'][] = array(
            'text' => lang('Text.seller_latest_products'),
            'href' => $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widgets/seller_latest_product'),
            'active' => true,
        );

        $data['heading_title'] = lang('Heading.seller_latest_products');
        ...
        // Header
        $header_params = array(
            'title' => lang('Heading.seller_latest_products'),
        );
        ...
        $template_setting = [
            ...
            'permission' => 'Appearance/Marketplace/Widgets/Seller_Latest_Product',
            'override' => false,
        ];
    ...
    public function save()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            if (!$this->administrator->hasPermission('modify', 'Appearance/Marketplace/Widgets/Seller_Latest_Product')) {
