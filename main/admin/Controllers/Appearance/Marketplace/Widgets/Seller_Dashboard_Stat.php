...
class Seller_Dashboard_Stat extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widget/Seller_Dashboard_Stat/save/' . $this->uri->getSegment($this->uri->getTotalSegments()));
    ...
    public function get_form($data)
    {
        ...
        $data['breadcrumbs'][] = array(
            'text' => lang('Text.seller_dashboard_stat'),
            'href' => $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widgets/seller_dashboard_stat'),
            'active' => true,
        );

        $data['heading_title'] = lang('Heading.seller_dashboard_stat');
        ...
        // Header
        $header_params = array(
            'title' => lang('Heading.seller_dashboard_stat'),
        );
        ...
        $template_setting = [
            ...
            'permission' => 'Appearance/Marketplace/Widgets/Seller_Dashboard_Stat',
            'override' => false,
        ];
    ...
    public function save()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            if (!$this->administrator->hasPermission('modify', 'Appearance/Marketplace/Widgets/Seller_Dashboard_Stat')) {
