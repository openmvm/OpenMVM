...
class Seller_Description extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widget/Seller_Description/save/' . $this->uri->getSegment($this->uri->getTotalSegments()));
    ...
    public function get_form($data)
    {
        ...
        $data['breadcrumbs'][] = array(
            'text' => lang('Text.seller_description'),
            'href' => $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widgets/seller_description'),
            'active' => true,
        );

        $data['heading_title'] = lang('Heading.seller_description');
        ...
        // Header
        $header_params = array(
            'title' => lang('Heading.seller_description'),
        );
        ...
        $template_setting = [
            ...
            'permission' => 'Appearance/Marketplace/Widgets/Seller_Description',
            'override' => false,
        ];
    ...
    public function save()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            if (!$this->administrator->hasPermission('modify', 'Appearance/Marketplace/Widgets/Seller_Description')) {
