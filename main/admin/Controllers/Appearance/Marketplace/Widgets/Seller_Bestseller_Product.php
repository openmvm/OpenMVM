...
class Seller_Bestseller_Product extends \App\Controllers\BaseController
{
    /**
     * Constructor.
     */
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widget/Seller_Bestseller_Product/save/' . $this->uri->getSegment($this->uri->getTotalSegments()));
    ...
    public function get_form($data)
    {
        ...
        $data['breadcrumbs'][] = array(
            'text' => lang('Text.seller_bestseller_products'),
            'href' => $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widgets/seller_bestseller_product'),
            'active' => true,
        );

        $data['heading_title'] = lang('Heading.seller_bestseller_products');
        ...
        // Header
        $header_params = array(
            'title' => lang('Heading.seller_bestseller_products'),
        );
        ...
        $template_setting = [
            ...
            'author' => 'com_openmvm',
            'theme' => 'Basic',
            'view' => 'Appearance\Marketplace\Widgets\seller_bestseller_product',
            'permission' => 'Appearance/Marketplace/Widgets/Seller_Bestseller_Product',
            'override' => false,
        ];
    ...
    public function save()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            if (!$this->administrator->hasPermission('modify', 'Appearance/Marketplace/Widgets/Seller_Bestseller_Product')) {
