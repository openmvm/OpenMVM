...
class Seller_Menu extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widget/Seller_Menu/save/' . $this->uri->getSegment($this->uri->getTotalSegments()));
    ...
    public function get_form($data)
    {
        ...
        $data['breadcrumbs'][] = array(
            'text' => lang('Text.seller_menu'),
            'href' => $this->url->administratorLink(env('app.adminUrlSegment') . '/appearance/marketplace/widgets/seller_menu'),
            'active' => true,
        );

        $data['heading_title'] = lang('Heading.seller_menu');
        ...
        // Header
        $header_params = array(
            'title' => lang('Heading.seller_menu'),
        );
        ...
        $template_setting = [
            ...
            'permission' => 'Appearance/Marketplace/Widgets/Seller_Menu',
            'override' => false,
        ];
    ...
    public function save()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            if (!$this->administrator->hasPermission('modify', 'Appearance/Marketplace/Widgets/Seller_Menu')) {
