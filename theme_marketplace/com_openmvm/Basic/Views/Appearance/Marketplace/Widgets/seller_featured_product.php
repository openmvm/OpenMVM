...
<div id="widget-seller-featured-product-<?php echo $widget; ?>" class="card shadow rounded-0 mb-3">
    <div class="card-body">
        <div class="lead mb-3"><?php echo lang('Text.featured_products', [], $language_lib->getCurrentCode()); ?></div>
        <div class="row g-3">
