                            ...
                            <tr>
                                <th scope="row">
                                    <div class="form-check">
                                        <?php if (in_array($seller_category['seller_category_id'], $selected)) { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $seller_category['seller_category_id']; ?>" id="input-selected-<?php echo $seller_category['seller_category_id']; ?>" checked="checked">
                                        <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $seller_category['seller_category_id']; ?>" id="input-selected-<?php echo $seller_category['seller_category_id']; ?>">
                                        <?php } ?>
                                    </div>                                        
                                </th>
                                <td><?php echo $seller_category['name']; ?></td>
                                <td><?php echo $seller_category['sort_order']; ?></td>
                                <td><?php echo $seller_category['status']; ?></td>
                                <td class="text-end"><a href="<?php echo $seller_category['href']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
