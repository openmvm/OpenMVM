...
<div class="container">
    <div id="content" class="content">
        ...
        <div class="card shadow list">
            ...
            <div class="card-body">
                <fieldset>
                    <legend class="border-bottom pb-2 mb-3 fs-6"><?php echo lang('Text.general', [], 'en'); ?></legend>
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-1">
                            ...
                            <input type="text" name="option_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($option_description[$language['language_id']]['name']) ? $option_description[$language['language_id']]['name'] : ''; ?>" id="input-description-name-<?php echo $language['language_id']; ?>" class="form-control" placeholder="<?php echo lang('Entry.name', [], 'en'); ?>" aria-label="<?php echo lang('Entry.name', [], 'en'); ?>" aria-describedby="input-group-name-<?php echo $language['language_id']; ?>">
                        </div>
                        <?php } ?>
                    </div>
                    <div class="mb-3">
                        <label for="input-sort-order" class="form-label"><?php echo lang('Entry.sort_order', [], 'en'); ?></label>
                        <input type="number" name="sort_order" value="<?php echo $sort_order; ?>" class="form-control" id="input-sort-order" placeholder="<?php echo lang('Entry.sort_order', [], 'en'); ?>">
                    </div>
                    <legend class="border-bottom pb-2 mb-3 fs-6"><?php echo lang('Text.values', [], 'en'); ?></legend>
                        ...
                        <?php if (!empty($option_values)) { ?>
                            ...
                            <div id="option-value-<?php echo $option_value_row; ?>" class="position-relative bg-light pt-3 pe-3 pb-3 ps-3 mb-1">
                                ...
                                <div>
                                    ...
                                    <div class="mb-2"><?php echo lang('Entry.name', [], 'en'); ?></div>
                                    <?php foreach ($languages as $language) { ?>
                                    <div class="input-group mb-1">
                                    ...
                                    <?php } ?>
                                    <div class="mt-2 mb-3">
                                        <label for="input-value-<?php echo $option_value_row; ?>-sort-order" class="form-label"><?php echo lang('Entry.sort_order', [], 'en'); ?></label>
                                        <input type="number" name="option_value[<?php echo $option_value_row; ?>][sort_order]" value="<?php echo $option_value['sort_order']; ?>" class="form-control" id="input-value-<?php echo $option_value_row; ?>-sort-order" placeholder="<?php echo lang('Entry.sort_order', [], 'en'); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <?php } ?>
                        <?php } ?>
                        <div class="d-grid"><button type="button" id="button-option-value-add" class="btn btn-outline-primary" onclick="addOptionValue();"><i class="fas fa-plus-circle"></i> <?php echo lang('Button.value_add', [], 'en'); ?></button></div>
                    </div>
                </fieldset>
            </div>
        </div>
...
function addOptionValue() {
    ...
    html += '           <input type="text" name="option_value[' + option_value_row + '][description][<?php echo $language['language_id']; ?>][name]" value="" class="form-control" placeholder="<?php echo lang('Entry.name', [], 'en'); ?>" aria-label="<?php echo lang('Entry.name', [], 'en'); ?>" aria-describedby="input-group-value-' + option_value_row + '-name-<?php echo $language['language_id']; ?>">';
    html += '       </div>';
        <?php } ?>
    html += '       <div class="mb-3">';
    html += '           <label for="input-value-' + option_value_row + '-sort-order" class="form-label"><?php echo lang('Entry.sort_order', [], 'en'); ?></label>';
    html += '           <input type="number" name="option_value[' + option_value_row + '][sort_order]" class="form-control" id="input-value-' + option_value_row + '-sort-order" placeholder="<?php echo lang('Entry.sort_order', [], 'en'); ?>">';
    html += '       </div>';
    html += '   </div>';
    html += '</div>';
