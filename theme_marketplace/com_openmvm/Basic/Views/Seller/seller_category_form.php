    ...
    <div id="content" class="content">
        ...
        <div class="card shadow list">
            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="seller-category-tab-content">
                            ...
                            <div class="tab-pane fade" id="language-<?php echo $language['language_id']; ?>" role="tabpanel" aria-labelledby="language-tab-<?php echo $language['language_id']; ?>">
                                <fieldset>
                                    <div class="mb-3 required">
                                        ...
                                        <input type="text" name="seller_category_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($seller_category_description[$language['language_id']]['name']) ? $seller_category_description[$language['language_id']]['name']: ''; ?>" id="input-name-<?php echo $language['language_id']; ?>" class="form-control" placeholder="<?php echo lang('Entry.name'); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="input-description-<?php echo $language['language_id']; ?>" class="form-label"><?php echo lang('Entry.description'); ?></label>
                                        <textarea rows="10" name="seller_category_description[<?php echo $language['language_id']; ?>][description]" id="input-description-<?php echo $language['language_id']; ?>" class="form-control editor" placeholder="<?php echo lang('Entry.description'); ?>"><?php echo isset($seller_category_description[$language['language_id']]['description']) ? $seller_category_description[$language['language_id']]['description'] : ''; ?></textarea>
                                    </div>
                                    <div class="mb-3 required">
                                        <label for="input-meta-title-<?php echo $language['language_id']; ?>" class="form-label"><?php echo lang('Entry.meta_title'); ?></label>
                                        <input type="text" name="seller_category_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($seller_category_description[$language['language_id']]['meta_title']) ? $seller_category_description[$language['language_id']]['meta_title'] : ''; ?>" id="input-meta-title-<?php echo $language['language_id']; ?>" class="form-control" placeholder="<?php echo lang('Entry.meta_title'); ?>">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <textarea rows="5" name="seller_category_description[<?php echo $language['language_id']; ?>][meta_description]" id="input-meta-description-<?php echo $language['language_id']; ?>" class="form-control" placeholder="<?php echo lang('Entry.meta_description'); ?>"><?php echo isset($seller_category_description[$language['language_id']]['meta_description']) ? $seller_category_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="input-meta-keywords-<?php echo $language['language_id']; ?>" class="form-label"><?php echo lang('Entry.meta_keywords'); ?></label>
                                        <input type="text" name="seller_category_description[<?php echo $language['language_id']; ?>][meta_keywords]" value="<?php echo isset($seller_category_description[$language['language_id']]['meta_keywords']) ? $seller_category_description[$language['language_id']]['meta_keywords'] : ''; ?>" id="input-meta-keywords-<?php echo $language['language_id']; ?>" class="form-control" placeholder="<?php echo lang('Entry.meta_keywords'); ?>">
                                    </div>
                                </fieldset>
                            </div>
                            <?php } ?>
...
$( '#input-parent' ).autocomplete({
    source: function (request, response) {
        $.ajax({
            url: '<?php echo $seller_category_autocomplete_url; ?>',
            dataType: 'json',
            data: {
    ...
    select: function( event, ui ) {
        ...
        $('#input-parent-id').val(ui.item.seller_category_id);
        $('#input-parent').autocomplete('close');
        console.log( 'Selected: ' + ui.item.name + ' aka ' + ui.item.seller_category_id );
        return false;
    }
}).focus(function () {
