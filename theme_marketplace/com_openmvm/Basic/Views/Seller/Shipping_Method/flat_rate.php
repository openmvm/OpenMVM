            ...
            <div class="card-body">
                <fieldset>
                    <div class="mb-3 required">
                        <label for="input-rate" class="form-label"><?php echo lang('Entry.rate'); ?></label>
                        <input type="number" step="any" min="0" name="rate" value="<?php echo $rate; ?>" id="input-rate" class="form-control" placeholder="<?php echo lang('Entry.rate'); ?>">
