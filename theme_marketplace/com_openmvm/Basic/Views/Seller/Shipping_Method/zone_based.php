                ...
                <fieldset>
                    ...
                    <div id="rates" class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th><?php echo lang('Column.country'); ?></th>
                                    <th><?php echo lang('Column.zone'); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr id="rate-<?php echo $rate_row; ?>">
                                    ...
                                    <td>
                                        <select name="rate[<?php echo $rate_row; ?>][zone_id]" class="form-control" id="input-rate-zone-<?php echo $rate_row; ?>" disabled="disabled"><option value="0"><?php echo lang('Text.all_zones'); ?></option></select>
                                    </td>
...
$( "#button-add-rate" ).on( "click", function() {
    ...
    html += '        </select>';
    html += '    </td>';
    html += '    <td><select name="rate[' + rate_row + '][zone_id]" class="form-control" id="input-rate-zone-' + rate_row + '"><option value="0"><?php echo lang('Text.all_zones'); ?></option></select></td>';
