...
<div class="container">
    <div id="content" class="content">
        ...
        <div class="row">
            <div class="col-sm-7">
                <h3 class="border-bottom border-3 pb-3 mb-3"><?php echo lang('Heading.payment_address'); ?></h3>
                <div id="checkout-payment-address" class="mb-3"><i class="fas fa-spinner fa-spin"></i></div>
                <h3 class="border-bottom border-3 pb-3 mb-3"><?php echo lang('Heading.shipping_address'); ?></h3>
                <div id="checkout-shipping-address" class="mb-3"><i class="fas fa-spinner fa-spin"></i></div>
                <h3 class="border-bottom border-3 pb-3 mb-3"><?php echo lang('Heading.shipping_method'); ?></h3>
                <div id="checkout-shipping-method" class="mb-3"><i class="fas fa-spinner fa-spin"></i></div>
                <h3 class="border-bottom border-3 pb-3 mb-3"><?php echo lang('Heading.payment_method'); ?></h3>
                <div id="checkout-payment-method" class="mb-3"><i class="fas fa-spinner fa-spin"></i></div>
            </div>
            <div class="col-sm-5">
                <h3 class="border-bottom border-3 pb-3 mb-3"><?php echo lang('Heading.shopping_cart'); ?></h3>
                <div id="checkout-cart"><i class="fas fa-spinner fa-spin"></i></div>
                <h3 class="border-bottom border-3 pb-3 mb-3"><?php echo lang('Heading.confirm'); ?></h3>
