...
<select name="checkout_payment_address" class="form-control">
...
//--></script> 
<?php } else { ?>
<div class="alert alert-warning" role="alert"><?php echo lang('Error.payment_address_not_found'); ?></div>
<script type="text/javascript"><!--
$(document).ready(function() {
	$('#form-checkout-payment-address-add').removeClass('d-none');
});
...
<div id="form-checkout-payment-address-add" class="d-none">
	<fieldset>
        <div class="mb-3 required">
            <label for="input-checkout-payment-address-firstname" class="form-label"><?php echo lang('Entry.firstname'); ?></label>
            <input type="text" name="firstname" value="" id="input-checkout-payment-address-firstname" class="form-control" placeholder="<?php echo lang('Entry.firstname'); ?>">
        </div>
        <div class="mb-3 required">
            <label for="input-checkout-payment-address-lastname" class="form-label"><?php echo lang('Entry.lastname'); ?></label>
            <input type="text" name="lastname" value="" id="input-checkout-payment-address-lastname" class="form-control" placeholder="<?php echo lang('Entry.lastname'); ?>">
        </div>
        <div class="mb-3 required">
            <label for="input-checkout-payment-address-address-1" class="form-label"><?php echo lang('Entry.address_1'); ?></label>
            <textarea rows="5" name="address_1" id="input-checkout-payment-address-address-1" class="form-control" placeholder="<?php echo lang('Entry.address_1'); ?>"></textarea>
        </div>
        <div class="mb-3">
            <label for="input-checkout-payment-address-address-2" class="form-label"><?php echo lang('Entry.address_2'); ?></label>
            <textarea rows="5" name="address_2" id="input-checkout-payment-address-address-2" class="form-control" placeholder="<?php echo lang('Entry.address_2'); ?>"></textarea>
        </div>
        <div class="mb-3 required">
            <label for="input-checkout-payment-address-city" class="form-label"><?php echo lang('Entry.city'); ?></label>
            <input type="text" name="city" value="" id="input-checkout-payment-address-city" class="form-control" placeholder="">
        </div>
        <div class="mb-3 required">
            <label for="input-checkout-payment-address-country" class="form-label"><?php echo lang('Entry.country'); ?></label>
            <select name="country_id" id="input-checkout-payment-address-country" class="form-control">
        ...
        <div class="mb-3 required">
            <label for="input-checkout-payment-address-zone" class="form-label"><?php echo lang('Entry.zone'); ?></label>
            <select name="zone_id" id="input-checkout-payment-address-zone" class="form-control"></select>
        </div>
        <div class="mb-3 required">
            <label for="input-checkout-payment-address-telephone" class="form-label"><?php echo lang('Entry.telephone'); ?></label>
            <input type="text" name="telephone" value="" id="input-checkout-payment-address-telephone" class="form-control" placeholder="<?php echo lang('Entry.telephone'); ?>">
        </div>
	</fieldset>
	<div class="buttons clearfix">
		<div class="float-end"><button type="button" class="btn btn-primary" id="button-checkout-payment-address-add"><i class="fas fa-plus-circle fa-fw"></i> <?php echo lang('Button.add'); ?></button></div>
	</div>
</div>
<script type="text/javascript"><!--
...
$('#form-checkout-payment-address-add #button-checkout-payment-address-add').on('click', function() {
	$.ajax({
		url: '<?php echo base_url(); ?>' + '/marketplace/checkout/checkout/add_address?type=payment_address',
		type: 'post',
