            ...
            <div class="card shadow mx-auto" style="max-width: 300px;">
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        <button type="button" class="btn btn-primary button-action" data-form="form-login" data-form-action="<?php echo $action; ?>" data-icon="fa-lock" data-toast-heading-title-success="<?php echo lang('Text.success', [], $language_lib->getCurrentCode()); ?>" data-toast-heading-title-error="<?php echo lang('Text.error', [], $language_lib->getCurrentCode()); ?>" data-toast-heading-icon-success="fa-check-circle" data-toast-heading-icon-error="fa-triangle-exclamation" data-redirection="true"><i class="fas fa-lock fa-fw"></i> <?php echo lang('Button.login', [], $language_lib->getCurrentCode()); ?></button>
                    </div>
                    <div class="mt-3"><a href="<?php echo $reset_password; ?>" class="text-decoration-none"><?php echo lang('Text.forgot_password', [], $language_lib->getCurrentCode()); ?></a></div>
                    <div class="mt-3"><a href="<?php echo $register; ?>" class="text-decoration-none"><?php echo lang('Text.register', [], $language_lib->getCurrentCode()); ?></a></div>
                </div>
            </div>
        </div>
        <?php echo form_close(); ?>
