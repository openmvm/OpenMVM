    ...
    <div id="content" class="content">
        ...
        <fieldset>
            <div class="mb-3 required">
                ...
                <input type="text" name="username" value="<?php echo $username; ?>" id="input-username" class="form-control" placeholder="<?php echo lang('Entry.username', [], $language_lib->getCurrentCode()); ?>">
