...
class Administrator extends \App\Controllers\BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->model_administrator_administrator = new \App\Models\Admin\Administrator\Administrator_Model();
    }
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->administratorLink('admin/administrator/administrator');
        ...
        if ($this->request->getMethod() == 'post' && !empty($this->request->getPost('selected'))) {
            if (!$this->administrator->hasPermission('modify', 'Administrator/Administrator')) {
                ...
                return redirect()->to($this->url->administratorLink('admin/administrator/administrator'));
            }
            ...
            $this->session->set('success', lang('Success.administrator_delete'));
    ...
    public function add()
    {
        ...
        $data['action'] = $this->url->administratorLink('admin/administrator/administrator/add');

        if ($this->request->getMethod() == 'post') {
            if (!$this->administrator->hasPermission('modify', 'Administrator/Administrator')) {
                $this->session->set('error', lang('Error.modify_permission'));

                return redirect()->to($this->url->administratorLink('admin/administrator/administrator/add'));
            }
            ...
            if ($this->validation->withRequest($this->request)->run()) {
                ...
                $this->session->set('success', lang('Success.administrator_add'));
    ...
    public function edit()
    {
        ...
        $data['action'] = $this->url->administratorLink('admin/administrator/administrator/edit/' . $this->uri->getSegment($this->uri->getTotalSegments()));

        if ($this->request->getMethod() == 'post') {
            if (!$this->administrator->hasPermission('modify', 'Administrator/Administrator')) {
                $this->session->set('error', lang('Error.modify_permission'));

                return redirect()->to($this->url->administratorLink('admin/administrator/administrator/edit/' . $this->uri->getSegment($this->uri->getTotalSegments())));
            }
            ...
            if ($this->validation->withRequest($this->request)->run()) {
                ...
                $this->session->set('success', lang('Success.administrator_edit'));
    ...
    public function get_list($data)
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->administratorLink('admin/administrator_administrator'),
            'active' => true,
        );
        ...
        foreach ($administrators as $administrator) {
            $data['administrators'][] = [
                ...
                'href' => $this->url->administratorLink('admin/administrator/administrator/edit/' . $administrator['administrator_id']),
            ];
        }
        ...
        $data['add'] = $this->url->administratorLink('admin/administrator/administrator/add');
