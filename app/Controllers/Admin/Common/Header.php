...
class Header extends \App\Controllers\BaseController
{
    ...
    public function index($header_params = array())
    {
        ...
        $data['profile'] = $this->url->administratorLink('admin/administrator/administrator/edit/' . $this->administrator->getId());
        ...
        return $this->template->render('ThemeAdmin', 'com_openmvm', 'Basic', 'Common\header', $data);
    }
}
