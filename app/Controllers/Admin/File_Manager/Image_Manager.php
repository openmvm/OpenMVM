...
namespace App\Controllers\Admin\File_Manager;
...
class Image_Manager extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $data['image_manager_workspace'] = $this->url->administratorLink('admin/file_manager/image_manager/workspace');
    ...
    {
        $data['create_directory'] = $this->url->administratorLink('admin/file_manager/image_manager/create_directory');
        $data['upload'] = $this->url->administratorLink('admin/file_manager/image_manager/upload');
        $data['compress'] = $this->url->administratorLink('admin/file_manager/image_manager/compress');
        $data['download'] = $this->url->administratorLink('admin/file_manager/image_manager/download');
        $data['rebuild_cache'] = $this->url->administratorLink('admin/file_manager/image_manager/rebuild_cache');
        $data['refresh'] = $this->url->administratorLink('admin/file_manager/image_manager/refresh');
        $data['remove'] = $this->url->administratorLink('admin/file_manager/image_manager/remove');
