...
class Zone_Based extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->administratorLink('admin/component/shipping_method/zone_based');
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if ($this->validation->withRequest($this->request)->run()) {
                ...
                if ($this->validation->hasError('component_shipping_method_zone_based_amount')) {
                    $data['error_component_shipping_method_zone_based_amount'] = $this->validation->getError('component_shipping_method_zone_based_amount');
                } else {
                    $data['error_component_shipping_method_zone_based_amount'] = '';
                }
            }
        }
    ...
    public function get_form($data)
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->administratorLink('admin/component/shipping_method/zone_based'),
            'active' => true,
        );
        ...
        if ($this->request->getPost('component_shipping_method_zone_based_amount')) {
            $data['component_shipping_method_zone_based_amount'] = $this->request->getPost('component_shipping_method_zone_based_amount');
        } else {
        ...
        if ($this->request->getPost('component_shipping_method_zone_based_sort_order')) {
            $data['component_shipping_method_zone_based_sort_order'] = $this->request->getPost('component_shipping_method_zone_based_sort_order');
        } else {
        ...
        if ($this->request->getPost('component_shipping_method_zone_based_status')) {
            $data['component_shipping_method_zone_based_status'] = $this->request->getPost('component_shipping_method_zone_based_status');
        } else {
