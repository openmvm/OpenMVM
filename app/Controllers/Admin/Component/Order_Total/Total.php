...
class Total extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->administratorLink('admin/component/order_total/total');
    ...
    public function get_form($data)
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->administratorLink('admin/component/order_total/total'),
            'active' => true,
        );
        ...
        if ($this->request->getPost('component_order_total_total_sort_order')) {
            $data['component_order_total_total_sort_order'] = $this->request->getPost('component_order_total_total_sort_order');
        } else {
        ...
        if ($this->request->getPost('component_order_total_total_status')) {
            $data['component_order_total_total_status'] = $this->request->getPost('component_order_total_total_status');
        } else {
