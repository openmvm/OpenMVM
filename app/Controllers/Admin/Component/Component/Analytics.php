...
class Analytics extends \App\Controllers\BaseController
{
    ...
    public function get_list($data)
    {
        ...
        $directory = ROOTPATH . '/app/Controllers/Admin/Component/Analytics/';
        ...
        foreach ($analytics as $analytic) {
            ...
            $data['analytics'][] = [
                ...
                'author' => 'com_openmvm',
                'installed' => $installed,
                'install' => $this->url->administratorLink('admin/component/component/analytics/install', ['author' => 'com_openmvm', 'component' => $pathinfo['filename']]),
                'uninstall' => $this->url->administratorLink('admin/component/component/analytics/uninstall', ['author' => 'com_openmvm', 'component' => $pathinfo['filename']]),
                'edit' => $this->url->administratorLink('admin/component/analytics/' . strtolower($pathinfo['filename'])),
            ];
        }
