...
class Order_Total extends \App\Controllers\BaseController
{
    ...
    public function get_list($data)
    {
        ...
        $directory = ROOTPATH . '/app/Controllers/Admin/Component/Order_Total/';
        ...
        foreach ($order_totals as $order_total) {
            ...
            $data['order_totals'][] = [
                ...
                'author' => 'com_openmvm',
                'installed' => $installed,
                'install' => $this->url->administratorLink('admin/component/component/order_total/install', ['author' => 'com_openmvm', 'component' => $pathinfo['filename']]),
                'uninstall' => $this->url->administratorLink('admin/component/component/order_total/uninstall', ['author' => 'com_openmvm', 'component' => $pathinfo['filename']]),
                'edit' => $this->url->administratorLink('admin/component/order_total/' . strtolower($pathinfo['filename'])),
            ];
        }
