...
class Link extends \App\Controllers\BaseController
{
    ...
    public function edit()
    {
        ...
        $data['action'] = $this->url->administratorLink('admin/appearance/marketplace/widgets/link/edit/' . $this->uri->getSegment($this->uri->getTotalSegments()));
    ...
    public function get_form($data)
    {
        ...
        $data['breadcrumbs'][] = array(
            'text' => lang('Text.Link'),
            'href' => $this->url->administratorLink('admin/appearance/marketplace/widgets/link'),
            'active' => true,
        );
        ...
        if ($this->request->getPost('link')) {
            $data['links'] = $this->request->getPost('link');
        } elseif ($widget_info) {
        ...
        if ($this->administrator->hasPermission('access', 'Appearance/Marketplace/Widgets/Link')) {
            // Header
            $scripts = [
            ...
            return $this->template->render('ThemeAdmin', 'com_openmvm', 'Basic', 'Appearance\Marketplace\Widgets\link', $data);
        } else {
            $data = [];
