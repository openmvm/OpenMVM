...
class Theme extends \App\Controllers\BaseController
{
    ...
    public function index()
    {
        ...
        foreach ($themes as $theme) {
            ...
            if ($extension_info) {
                ...
                $info = file_get_contents($this->url->administratorLink('admin/appearance/marketplace/theme/' . strtolower($theme_author) . '/' . strtolower($theme_name) . '/get_info'));
            ...
            $data['themes'][] = [
                ...
                'theme_image' => $image,
                'link' => $link,
                'href' => $this->url->administratorLink('admin/appearance/marketplace/theme/' . strtolower($theme_author) . '/' . strtolower($theme_name)),
                'activated' => $activated,
                'activate' => base_url() . '/admin/appearance/marketplace/theme/activate?administrator_token=' . $this->administrator->getToken() . '&theme=' . $theme_author . ':' . $theme_name,
                'deactivate' => base_url() . '/admin/appearance/marketplace/theme/deactivate?administrator_token=' . $this->administrator->getToken() . '&theme=' . $theme_author . ':' . $theme_name,
                'set' => base_url() . '/admin/appearance/marketplace/theme/set_marketplace_theme?administrator_token=' . $this->administrator->getToken() . '&theme=' . $theme_author . ':' . $theme_name,
                'remove' => base_url() . '/admin/appearance/marketplace/theme/remove?administrator_token=' . $this->administrator->getToken() . '&theme=' . $theme_author . ':' . $theme_name,
            ];
        }
        ...
        if ($this->administrator->hasPermission('access', 'Appearance/Marketplace/Theme')) {
            ...
            return $this->template->render('ThemeAdmin', 'com_openmvm', 'Basic', 'Appearance\Marketplace\theme', $data);
        } else {
            $data = [];
    ...
    public function set_marketplace_theme()
    {
        ...
        if (!$this->administrator->hasPermission('access', 'Appearance/Marketplace/Theme')) {
            ...
            return redirect()->to('admin/appearance/marketplace/theme?administrator_token=' . $this->request->getGet('administrator_token') . '&error=error_permission');
        }
        ...
        if (empty($this->request->getGet('theme'))) {
            ...
            return redirect()->to('admin/appearance/marketplace/theme?administrator_token=' . $this->request->getGet('administrator_token') . '&error=error_theme');
        }
        ...
        if (empty($error)) {
            ...
            return redirect()->to('admin/appearance/marketplace/theme?administrator_token=' . $this->request->getGet('administrator_token') . '&error=none');
        }
    }
    ...
    public function activate()
    {
        ...
        if (!$this->administrator->hasPermission('access', 'Appearance/Marketplace/Theme')) {
            ...
            return redirect()->to('admin/appearance/marketplace/theme?administrator_token=' . $this->request->getGet('administrator_token'));
        }
