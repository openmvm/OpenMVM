...
class Header extends \App\Controllers\BaseController
{
    ...
    public function __construct()
    {
        ...
        // Common Controllers
        $this->marketplace_search = new \App\Controllers\Marketplace\Common\Search();
        $this->marketplace_language = new \App\Controllers\Marketplace\Common\Language();
        $this->marketplace_currency = new \App\Controllers\Marketplace\Common\Currency();
