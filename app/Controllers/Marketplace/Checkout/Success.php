...
class Success extends \App\Controllers\BaseController
{
    ...
    {
        // Models
        $this->model_account_order = new \App\Models\Marketplace\Account\Order_Model();
    ...
    public function index()
    {
        ...
        $data['heading_title'] = lang('Heading.success');
        ...
        if ($order_info) {
            ...
            $data['order_add_message_3'] = sprintf(lang('Text.order_add_message_3', [], $this->language->getCurrentCode()), $this->url->customerLink('marketplace/account/order', '', true));

            // Header
            $header_params = array(
                'title' => lang('Heading.success'),
            ...
            return $this->template->render('ThemeMarketplace', 'com_openmvm', 'Basic', 'Checkout\success', $data);
        } else {
