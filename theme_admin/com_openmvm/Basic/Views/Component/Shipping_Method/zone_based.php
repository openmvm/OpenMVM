            ...
            <div class="card-body">
                <fieldset>
                    <div class="mb-3 required">
                        ...
                        <input type="number" step="any" min="0" name="component_shipping_method_zone_based_amount" value="<?php echo $component_shipping_method_zone_based_amount; ?>" id="input-amount" class="form-control" placeholder="<?php echo lang('Entry.amount'); ?>">
                        <div class="text-muted small"><?php echo lang('Help.checkout_total_amount'); ?></div>
                        <?php if (!empty($error_component_shipping_method_zone_based_amount)) { ?><div class="text-danger small"><?php echo $error_component_shipping_method_zone_based_amount; ?></div><?php } ?>
                    </div>
                    <div class="mb-3">
                        <label for="input-sort-order" class="form-label"><?php echo lang('Entry.sort_order'); ?></label>
                        <input type="number" step="any" min="0" name="component_shipping_method_zone_based_sort_order" value="<?php echo $component_shipping_method_zone_based_sort_order; ?>" id="input-sort-order" class="form-control" placeholder="<?php echo lang('Entry.sort_order'); ?>">
                    </div>
                    <div class="mb-3">
                        <label for="input-status" class="form-label"><?php echo lang('Entry.status'); ?></label>
                        <select name="component_shipping_method_zone_based_status" id="input-status" class="form-control">
                            <?php if ($component_shipping_method_zone_based_status) { ?>
