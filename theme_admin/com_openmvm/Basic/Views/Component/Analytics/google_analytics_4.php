            ...
            <div class="card-body">
                <fieldset>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="component_analytics_google_analytics_4_status" id="input-status" class="form-select">
