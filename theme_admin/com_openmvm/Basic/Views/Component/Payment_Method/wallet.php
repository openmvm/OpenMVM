            ...
            <div class="card-body">
                <fieldset>
                    <div class="mb-3 required">
                        ...
                        <?php foreach ($languages as $language) { ?>
                            <div class="form-floating mb-3">
                                <textarea name="component_payment_method_wallet_instruction_<?php echo $language['language_id']; ?>" class="form-control" placeholder="Leave a comment here" id="input-instruction-<?php echo $language['language_id']; ?>" style="height: 200px;"><?php echo ${'component_payment_method_wallet_instruction_' . $language['language_id']}; ?></textarea>
                    ...
                    <div class="mb-3 required">
                        ...
                        <input type="number" step="any" min="0" name="component_payment_method_wallet_amount" value="<?php echo $component_payment_method_wallet_amount; ?>" id="input-amount" class="form-control" placeholder="<?php echo lang('Entry.amount'); ?>">
                    ...
                    <div class="mb-3 required">
                        ...
                        <select name="component_payment_method_wallet_geo_zone_id" class="form-select" id="input-geo-zone">
                            <?php foreach ($geo_zones as $geo_zone) { ?>
                                <?php if ($geo_zone['geo_zone_id'] == $component_payment_method_wallet_geo_zone_id) { ?>
                    ...
                    <div class="mb-3 required">
                        ...
                        <select name="component_payment_method_wallet_order_status_id" class="form-select" id="input-order-status">
                            <?php foreach ($order_statuses as $order_status) { ?>
                                <?php if ($order_status['order_status_id'] == $component_payment_method_wallet_order_status_id) { ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="any" min="0" name="component_payment_method_wallet_sort_order" value="<?php echo $component_payment_method_wallet_sort_order; ?>" id="input-sort-order" class="form-control" placeholder="<?php echo lang('Entry.sort_order'); ?>">
                    </div>
                    <div class="mb-3">
                        <label for="input-status" class="form-label"><?php echo lang('Entry.status'); ?></label>
                        <select name="component_payment_method_wallet_status" id="input-status" class="form-select">
                            <?php if ($component_payment_method_wallet_status) { ?>
