            ...
            <div class="card-body">
                <fieldset>
                    <div class="mb-3 required">
                        ...
                        <?php foreach ($languages as $language) { ?>
                            <div class="form-floating mb-3">
                                <textarea name="component_payment_method_cash_on_delivery_instruction_<?php echo $language['language_id']; ?>" class="form-control" placeholder="Leave a comment here" id="instruction-<?php echo $language['language_id']; ?>" style="height: 200px;"><?php echo ${'component_payment_method_cash_on_delivery_instruction_' . $language['language_id']}; ?></textarea>
                                ...
                                <?php if (!empty(${'error_component_payment_method_cash_on_delivery_instruction_' . $language['language_id']})) { ?><div class="text-danger small"><?php echo ${'error_component_payment_method_cash_on_delivery_instruction_' . $language['language_id']}; ?></div><?php } ?>
                            </div>
                        <?php } ?>
                    </div>
                    <div class="mb-3 required">
                        <label for="input-amount" class="form-label"><?php echo lang('Entry.amount'); ?></label>
                        <input type="number" step="any" min="0" name="component_payment_method_cash_on_delivery_amount" value="<?php echo $component_payment_method_cash_on_delivery_amount; ?>" id="input-amount" class="form-control" placeholder="<?php echo lang('Entry.amount'); ?>">
                        <div class="text-muted small"><?php echo lang('Help.checkout_total_amount'); ?></div>
                        <?php if (!empty($error_component_payment_method_cash_on_delivery_amount)) { ?><div class="text-danger small"><?php echo $error_component_payment_method_cash_on_delivery_amount; ?></div><?php } ?>
                    </div>
                    <div class="mb-3 required">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="any" min="0" name="component_payment_method_cash_on_delivery_sort_order" value="<?php echo $component_payment_method_cash_on_delivery_sort_order; ?>" id="input-sort-order" class="form-control" placeholder="<?php echo lang('Entry.sort_order'); ?>">
                    </div>
                    <div class="mb-3">
