            ...
            <div class="card-body">
                <fieldset>
                    ...
                    <div class="mb-3 required">
                        ...
                        <select name="component_payment_method_bank_transfer_geo_zone_id" class="form-select" id="input-geo-zone">
                    ...
                    <div class="mb-3 required">
                        ...
                        <select name="component_payment_method_bank_transfer_order_status_id" class="form-select" id="input-order-status">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="component_payment_method_bank_transfer_status" id="input-status" class="form-select">
