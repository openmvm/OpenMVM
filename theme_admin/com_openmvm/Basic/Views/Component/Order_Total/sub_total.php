            ...
            <div class="card-body">
                <fieldset>
                    <div class="mb-3">
                        ...
                        <input type="number" step="any" min="0" name="component_order_total_sub_total_sort_order" value="<?php echo $component_order_total_sub_total_sort_order; ?>" id="input-sort-order" class="form-control" placeholder="<?php echo lang('Entry.sort_order'); ?>">
                    </div>
                    <div class="mb-3">
