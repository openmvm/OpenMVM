            ...
            <div class="card-body">
                <fieldset>
                    <div class="mb-3">
                        ...
                        <input type="number" step="any" min="0" name="component_order_total_total_sort_order" value="<?php echo $component_order_total_total_sort_order; ?>" id="input-sort-order" class="form-control" placeholder="<?php echo lang('Entry.sort_order'); ?>">
                    </div>
                    <div class="mb-3">
                        <label for="input-status" class="form-label"><?php echo lang('Entry.status'); ?></label>
                        <select name="component_order_total_total_status" id="input-status" class="form-control">
                            <?php if ($component_order_total_total_status) { ?>
