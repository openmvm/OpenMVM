                    ...
                    <tbody>
                        <?php if ($shipping_methods) { ?>
                            ...
                            <tr>
                                ...
                                <td class="text-end"><?php if ($shipping_method['installed']) { ?><a href="<?php echo $shipping_method['uninstall']; ?>" class="btn btn-outline-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.uninstall'); ?>" onclick="return confirm('<?php echo lang('Text.are_you_sure'); ?>');"><i class="fas fa-minus-circle fa-fw"></i></a> <a href="<?php echo $shipping_method['edit']; ?>" class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.edit'); ?>"><i class="fas fa-edit fa-fw"></i></a><?php } else { ?><a href="<?php echo $shipping_method['install']; ?>" class="btn btn-outline-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.install'); ?>"><i class="fas fa-magic fa-fw"></i></a><?php } ?></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
