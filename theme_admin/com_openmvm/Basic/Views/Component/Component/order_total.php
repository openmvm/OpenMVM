        ...
        <div class="card shadow list">
            ...
            <div class="card-body">
                <table class="table table-hover">
                    <caption><?php echo lang('Caption.list_of_order_totals'); ?></caption>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php if ($order_totals) { ?>
                            ...
                            <tr>
                                <td><?php echo $order_total['name']; ?></td>
                                <td><?php echo $order_total['author']; ?></td>
                                <td class="text-end"><?php if ($order_total['installed']) { ?><a href="<?php echo $order_total['uninstall']; ?>" class="btn btn-outline-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.uninstall'); ?>" onclick="return confirm('<?php echo lang('Text.are_you_sure'); ?>');"><i class="fas fa-minus-circle fa-fw"></i></a> <a href="<?php echo $order_total['edit']; ?>" class="btn btn-outline-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.edit'); ?>"><i class="fas fa-edit fa-fw"></i></a><?php } else { ?><a href="<?php echo $order_total['install']; ?>" class="btn btn-outline-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.install'); ?>"><i class="fas fa-magic fa-fw"></i></a><?php } ?></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
