                            ...
                            <tr>
                                <th scope="row">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $administrator['administrator_id']; ?>" id="input-selected-<?php echo $administrator['administrator_id']; ?>" checked="checked">
                                        <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $administrator['administrator_id']; ?>" id="input-selected-<?php echo $administrator['administrator_id']; ?>">
                                        <?php } ?>
                                    </div>                                        
                                </th>
                                ...
                                <td class="text-end"><a href="<?php echo $administrator['href']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
