                            ...
                            <tr>
                                <th scope="row">
                                    <div class="form-check">
                                        <?php if (in_array($page['page_id'], $selected)) { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $page['page_id']; ?>" id="input-selected-<?php echo $page['page_id']; ?>" checked="checked">
                                        <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $page['page_id']; ?>" id="input-selected-<?php echo $page['page_id']; ?>">
                                        <?php } ?>
                                    </div>                                        
                                </th>
                                <td><?php echo $page['title']; ?></td>
                                <td><?php echo ($page['status'] ? lang('Text.enabled') : lang('Text.disabled')); ?></td>
                                <td class="text-end"><a href="<?php echo $page['href']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
                            <td colspan="4" class="text-muted text-center"><?php echo lang('Error.no_data_found'); ?></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
