                            ...
                            <tr>
                                <th scope="row">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $customer_group['customer_group_id']; ?>" id="input-selected-<?php echo $customer_group['customer_group_id']; ?>" checked="checked">
                                        <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $customer_group['customer_group_id']; ?>" id="input-selected-<?php echo $customer_group['customer_group_id']; ?>">
                                        <?php } ?>
                                    </div>                                        
                                </th>
                                <td><?php echo $customer_group['name']; ?></td>
                                <td class="text-end"><a href="<?php echo $customer_group['href']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
