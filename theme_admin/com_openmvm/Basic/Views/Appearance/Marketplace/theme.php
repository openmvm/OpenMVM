                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-7">
                                <div class="card-body">
                                    ...
                                    <div class="small"><?php echo lang('Text.author'); ?>: <?php if ($theme['theme_link']) { ?><a href="<?php echo $theme['theme_link']; ?>" target="_blank"><?php echo $theme['theme_author']; ?></a><?php } else { ?><?php echo $theme['theme_author']; ?><?php } ?></div>
...
$('button[id=\'button-upload\']').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file\']').val() != '') {
			...
			$.ajax({
				url: '<?php echo base_url('/admin/appearance/marketplace/theme/upload?administrator_token=' . $administrator_token); ?>',
				type: 'post',
				dataType: 'json',
...
$('button[id=\'button-update\']').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-update input[name=\'file\']').val() != '') {
			...
			$.ajax({
				url: '<?php echo base_url('/admin/appearance/marketplace/theme/update?administrator_token=' . $administrator_token . '&theme='); ?>' + $(node).attr('data-theme'),
				type: 'post',
				dataType: 'json',
