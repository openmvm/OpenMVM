                            ...
                            <tr>
                                <th scope="row">
                                    <div class="form-check">
                                        <?php if (in_array($layout['layout_id'], $selected)) { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $layout['layout_id']; ?>" id="input-selected-<?php echo $layout['layout_id']; ?>" checked="checked">
                                        <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $layout['layout_id']; ?>" id="input-selected-<?php echo $layout['layout_id']; ?>">
                                        <?php } ?>
                                    </div>                                        
                                </th>
                                <td><?php echo $layout['name']; ?></td>
                                <td class="text-end"><a href="<?php echo $layout['href']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
