                            ...
                            <tr>
                                <th scope="row">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $country['country_id']; ?>" id="input-selected-<?php echo $country['country_id']; ?>" checked="checked">
                                        <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $country['country_id']; ?>" id="input-selected-<?php echo $country['country_id']; ?>">
                                        <?php } ?>
                                    </div>                                        
                                </th>
                                <td><?php echo $country['name']; ?> <?php if ($country['country_id'] == $default) { ?><strong>( <?php echo lang('Text.default'); ?> )</strong><?php } ?></td>
                                <td><?php echo $country['sort_order']; ?></td>
                                <td><?php echo $country['status']; ?></td>
                                <td class="text-end"><a href="<?php echo $country['href']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
