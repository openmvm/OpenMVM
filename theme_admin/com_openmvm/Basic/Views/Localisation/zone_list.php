                            ...
                            <tr>
                                <th scope="row">
                                    <div class="form-check">
                                        <?php if (in_array($zone['zone_id'], $selected)) { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $zone['zone_id']; ?>" id="input-selected-<?php echo $zone['zone_id']; ?>" checked="checked">
                                        <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $zone['zone_id']; ?>" id="input-selected-<?php echo $zone['zone_id']; ?>">
                                        <?php } ?>
                                    </div>                                        
                                </th>
                                <td><?php echo $zone['name']; ?> <?php if ($zone['zone_id'] == $default) { ?><strong>( <?php echo lang('Text.default'); ?> )</strong><?php } ?></td>
                                <td><?php echo $zone['country']; ?></td>
                                <td><?php echo $zone['sort_order']; ?></td>
                                <td><?php echo $zone['status']; ?></td>
                                <td class="text-end"><a href="<?php echo $zone['href']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
