...
<div class="container-fluid">
    <div id="content" class="content">
        ...
        <div class="card border-0 shadow heading mb-3">
            <div class="card-body">
                <h3 class="card-title"><i class="fas fa-order-status fa-fw"></i> <?php echo $heading_title; ?></h3>
            </div>
        </div>
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $order_status['order_status_id']; ?>" id="input-selected-<?php echo $order_status['order_status_id']; ?>" checked="checked">
                                        <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $order_status['order_status_id']; ?>" id="input-selected-<?php echo $order_status['order_status_id']; ?>">
                                        <?php } ?>
                                    </div>                                        
                                </th>
                                <td><?php echo $order_status['name']; ?></td>
                                <td class="text-end"><a href="<?php echo $order_status['href']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
