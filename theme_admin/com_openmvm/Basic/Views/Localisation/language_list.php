                            ...
                            <tr>
                                <th scope="row">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $language['language_id']; ?>" id="input-selected-<?php echo $language['language_id']; ?>" checked="checked">
                                        <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $language['language_id']; ?>" id="input-selected-<?php echo $language['language_id']; ?>">
                                        <?php } ?>
                                    </div>                                        
                                </th>
                                <td><?php echo $language['name']; ?> <?php if ($language['language_id'] == $default) { ?><strong>( <?php echo lang('Text.default'); ?> )</strong><?php } ?></td>
                                <td><?php echo $language['code']; ?></td>
                                <td><?php echo $language['sort_order']; ?></td>
                                <td><?php echo $language['status']; ?></td>
                                <td class="text-end"><a href="<?php echo $language['href']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
