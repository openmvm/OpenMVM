                            ...
                            <tr>
                                <th scope="row">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $weight_class['weight_class_id']; ?>" id="input-selected-<?php echo $weight_class['weight_class_id']; ?>" checked="checked">
                                        <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $weight_class['weight_class_id']; ?>" id="input-selected-<?php echo $weight_class['weight_class_id']; ?>">
                                        <?php } ?>
                                    </div>                                        
                                </th>
                                <td><?php echo $weight_class['title']; ?> <?php if ($weight_class['weight_class_id'] == $default) { ?><strong>( <?php echo lang('Text.default'); ?> )</strong><?php } ?></td>
                                <td><?php echo $weight_class['unit']; ?></td>
                                <td><?php echo $weight_class['value']; ?></td>
                                <td class="text-end"><a href="<?php echo $weight_class['href']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
