...
<div class="container-fluid">
    <div id="content" class="content">
        ...
        <?php echo form_open($action, ['id' => 'form-order']); ?>
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $order['order_id']; ?>" id="input-selected-<?php echo $order['order_id']; ?>" checked="checked">
                                        <?php } else { ?>
                                        <input class="form-check-input" type="checkbox" name="selected[]" value="<?php echo $order['order_id']; ?>" id="input-selected-<?php echo $order['order_id']; ?>">
                                        <?php } ?>
                                    </div>                                        
                                </th>
                                <td><?php echo $order['invoice']; ?></td>
                                <td class="text-end"><a href="<?php echo $order['info']; ?>" class="btn btn-outline-primary btn-sm"><i class="fas fa-eye fa-fw"></i></a></td>
                            </tr>
                            <?php } ?>
                        <?php } else { ?>
                        <tr>
