...
<section class="container content min-vh-100 mt-3">
	<h1><?php echo lang('Heading.heading_weight', array(), $lang->getFrontEndLocale()); ?></h1>
	  ...
	  <div class="accordion-item">
	    <h2 class="accordion-header" id="headingStoreForm">
	      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseStoreForm" aria-expanded="true" aria-controls="collapseStoreForm">
	        <i class="fas fa-shipping-fast fa-fw"></i>&nbsp;&nbsp;<?php echo lang('Heading.heading_weight', array(), $lang->getFrontEndLocale()); ?>
	      </button>
	    </h2>
	      	...
	      	<div>
			      <fieldset>
							<div class="form-floating mb-3">
							  <select name="vendor_<?php echo $vendor_id; ?>_shipping_weight_status" class="form-select" id="input-status" aria-label="status">
                  <?php if (${'vendor_' . $vendor_id . '_shipping_weight_status'}) { ?>
