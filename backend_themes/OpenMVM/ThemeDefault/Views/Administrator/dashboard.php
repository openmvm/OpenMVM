...
<div id="content-wrapper" class="content-wrapper min-vh-100">
	...
	<section class="heading-container bg-dark p-3">
		<h2 class="heading-title text-white"><i class="fas fa-tachometer-alt fa-fw"></i> <?php echo $heading_title; ?></h2>
  ...
  <!-- /.heading-container -->
	...
	<section class="content px-3">
		<h1 class="text-center">Welcome to the OpenMVM Dashboard!</h1>
	</section>
  <!-- /.content -->
<?php echo $footer; ?>
