		          ...
		          <div class="tab-pane show active" id="general" role="tabpanel" aria-labelledby="general-tab">
		            <fieldset>
							  	<div class="form-floating mb-3">
									  <textarea style="height: 200px" name="shipping_weight_rate" class="form-control<?php if ($validation->hasError('shipping_weight_rate')) { ?> is-invalid<?php } ?>" id="input-rate" placeholder="<?php echo lang('Entry.entry_rate', array(), $lang->getBackEndLocale()); ?>"><?php echo $shipping_weight_rate; ?></textarea>
									  <label for="input-rate"><?php echo lang('Entry.entry_rate', array(), $lang->getBackEndLocale()); ?></label>
									  <?php if ($validation->hasError('shipping_weight_rate')) { ?>
	                  <div class="text-danger small"><?php echo $validation->getError('shipping_weight_rate'); ?></div>
	                	<?php } ?>
									</div>
									<div class="form-floating mb-3">
			                  ...
			                  <?php } ?>
							  	...
							  	<div class="form-floating mb-3">
									...
									<div class="form-floating mb-3">
									  <select name="shipping_weight_status" class="form-select" id="input-status" aria-label="status">
		                  <?php if ($shipping_weight_status) { ?>
