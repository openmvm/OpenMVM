		  ...
		  <div class="accordion-item">
		    <h2 class="accordion-header" id="headingAdministratorGroup">
		      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAdministratorGroup" aria-expanded="true" aria-controls="collapseAdministratorGroup">
		        <i class="fas fa-images fa-fw"></i>&nbsp;&nbsp;<?php echo lang('Heading.heading_frontend_themes', array(), $lang->getBackEndLocale()); ?>
		      </button>
		    </h2>
		      ...
		      <div class="accordion-body">
		        <div class="table-responsive">
		          <table class="table table-hover">
		            <caption><?php echo lang('Caption.caption_list_of_frontend_themes', array(), $lang->getBackEndLocale()); ?></caption>
		            <thead>
		              <tr>
		            ...
		            <tbody>
		              <?php if ($theme_settings) { ?>
		                ...
		                <tr>
		                  <td><?php echo $theme_setting['name']; ?></td>
		                  <td><a href="<?php echo $theme_setting['edit']; ?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="<?php echo lang('Button.button_edit', array(), $lang->getBackEndLocale()); ?>"><i class="fa fa-edit"></i></a></td>
		                </tr>
		                <?php } ?>
		              <?php } else { ?>
		                <tr>
