...
<div id="content-wrapper" class="content-wrapper min-vh-100">
	...
	<section class="heading-container bg-dark p-3">
		<h2 class="heading-title text-white"><i class="fas fa-credit-card fa-fw"></i> <?php echo $heading_title; ?></h2>
		  ...
		  <div class="accordion-item">
		    <h2 class="accordion-header" id="headingAdministrator">
		      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAdministrator" aria-expanded="true" aria-controls="collapseAdministrator">
		        <i class="fas fa-credit-card fa-fw"></i>&nbsp;&nbsp;<?php echo lang('Heading.heading_payment_methods', array(), $lang->getBackEndLocale()); ?>
		      </button>
		    </h2>
		      ...
		      <div class="accordion-body">
						<div class="table-responsive">
						  <table class="table table-hover">
						    <caption class="small"><?php echo lang('Caption.caption_list_of_payment_methods', array(), $lang->getBackEndLocale()); ?></caption>
							  <thead>
							    <tr>
							  ...
							  <tbody>
							  	<?php if ($payment_methods) { ?>
								    ...
								    <tr>
				              <td class="align-middle"><?php echo $payment_method['name']; ?></td>
				              <td class="align-middle"><?php echo $payment_method['link']; ?></td>
				              <td class="align-middle"><?php echo $payment_method['status']; ?></td>
				              <td class="align-middle"><?php echo $payment_method['sort_order']; ?></td>
				              <td class="align-middle text-end">
				              	<?php if ($payment_method['installed']) { ?>
				              	<a href="<?php echo $payment_method['edit']; ?>" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.button_edit', array(), $lang->getBackEndLocale()); ?>"><i class="fas fa-edit"></i></a>
			              		<?php } else { ?>
			              		...
			              		<?php } ?>
				              	<?php if (!$payment_method['installed']) { ?>
				              	<a href="<?php echo $payment_method['install']; ?>" class="btn btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.button_install', array(), $lang->getBackEndLocale()); ?>"><i class="fas fa-object-group"></i></a>
			              		<?php } else { ?>
				              	<a href="<?php echo $payment_method['uninstall']; ?>" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.button_uninstall', array(), $lang->getBackEndLocale()); ?>"><i class="fas fa-object-ungroup"></i></a>
			              		<?php } ?>
				              </td>
								    </tr>
							  		<?php } ?>
