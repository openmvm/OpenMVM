  ...
  <!-- /.heading-container -->
    ...
    <div class="clearfix mb-3">
	    <div class="float-end">
	      ...
	      <a href="<?php echo base_url($_SERVER['app.adminDir'] . '/localisation/states/' . $administrator_token); ?>" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.button_cancel', array(), $lang->getBackEndLocale()); ?>"><i class="fas fa-long-arrow-alt-left"></i></a>
	    </div>
    </div>
		  ...
		  <div class="accordion-item">
		    ...
		    <div id="collapseAdministratorGroup" class="accordion-collapse collapse show" aria-labelledby="headingAdministratorGroup" data-bs-parent="#accordionAdministratorGroup">
		      <div class="accordion-body">
		        ...
		        <ul class="nav nav-tabs" id="stateTab" role="tablist">
		          <li class="nav-item">
