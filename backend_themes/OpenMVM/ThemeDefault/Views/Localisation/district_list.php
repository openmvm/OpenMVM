...
<div id="content-wrapper" class="content-wrapper min-vh-100">
  ...
  <!-- /.heading-container -->
    ...
    <?php echo form_open(base_url($_SERVER['app.adminDir'] . '/localisation/districts/' . $administrator_token)); ?>
    <div class="clearfix mb-3">
	    <div class="float-end">
	      <a href="<?php echo base_url($_SERVER['app.adminDir'] . '/localisation/districts/add/' . $administrator_token); ?>" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.button_add', array(), $lang->getBackEndLocale()); ?>"><i class="fas fa-plus"></i></a>
		  ...
		  <div class="accordion-item">
		    <h2 class="accordion-header" id="headingAdministratorGroup">
		      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAdministratorGroup" aria-expanded="true" aria-controls="collapseAdministratorGroup">
		        <i class="fas fa-globe-americas fa-fw"></i>&nbsp;&nbsp;<?php echo lang('Heading.heading_districts', array(), $lang->getBackEndLocale()); ?>
		      </button>
		    </h2>
		      ...
		      <div class="accordion-body">
		        <div class="table-responsive">
		          <table class="table table-hover">
		            <caption class="small"><?php echo lang('Caption.caption_list_of_districts', array(), $lang->getBackEndLocale()); ?></caption>
		            <thead>
		              <tr>
		                ...
		                <th scope="col"><?php echo lang('Column.column_city', array(), $lang->getBackEndLocale()); ?></th>
		            ...
		            <tbody>
		              <?php if ($districts) { ?>
		                ...
		                <tr>
		                  <th scope="row">
		                    <?php if (in_array($district['district_id'], $selected)) { ?>
		                    <input type="checkbox" name="selected[]" value="<?php echo $district['district_id']; ?>" checked="checked" />
		                    <?php } else { ?>
		                    <input type="checkbox" name="selected[]" value="<?php echo $district['district_id']; ?>" />
		                    <?php } ?>
		                  </th>
		                  <td><?php echo $district['name']; ?></td>
		                  <td><?php echo $district['country']; ?></td>
		                  <td><?php echo $district['state']; ?></td>
		                  <td><?php echo $district['city']; ?></td>
		                  <td><a href="<?php echo $district['edit']; ?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="<?php echo lang('Button.button_edit', array(), $lang->getBackEndLocale()); ?>"><i class="fa fa-edit"></i></a></td>
		                </tr>
		                <?php } ?>
		              <?php } else { ?>
		                <tr>
