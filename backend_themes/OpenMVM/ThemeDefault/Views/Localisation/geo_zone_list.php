...
<div id="content-wrapper" class="content-wrapper min-vh-100">
  ...
  <!-- /.heading-container -->
    ...
    <?php echo form_open(base_url($_SERVER['app.adminDir'] . '/localisation/geo_zones/' . $administrator_token)); ?>
    <div class="clearfix mb-3">
	    <div class="float-end">
	      <a href="<?php echo base_url($_SERVER['app.adminDir'] . '/localisation/geo_zones/add/' . $administrator_token); ?>" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.button_add', array(), $lang->getBackEndLocale()); ?>"><i class="fas fa-plus"></i></a>
		  ...
		  <div class="accordion-item">
		    <h2 class="accordion-header" id="headingAdministratorGroup">
		      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAdministratorGroup" aria-expanded="true" aria-controls="collapseAdministratorGroup">
		        <i class="fas fa-atlas fa-fw"></i>&nbsp;&nbsp;<?php echo lang('Heading.heading_geo_zones', array(), $lang->getBackEndLocale()); ?>
		      </button>
		    </h2>
		      ...
		      <div class="accordion-body">
		        <div class="table-responsive">
		          <table class="table table-hover">
		            <caption class="small"><?php echo lang('Caption.caption_list_of_geo_zones', array(), $lang->getBackEndLocale()); ?></caption>
		            <thead>
		              <tr>
		                ...
		                <th scope="col"><?php echo lang('Column.column_description', array(), $lang->getBackEndLocale()); ?></th>
		            ...
		            <tbody>
		              <?php if ($geo_zones) { ?>
		                ...
		                <tr>
		                  ...
		                  <td><?php echo $geo_zone['description']; ?></td>
		                  <td><a href="<?php echo $geo_zone['edit']; ?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="<?php echo lang('Button.button_edit', array(), $lang->getBackEndLocale()); ?>"><i class="fa fa-edit"></i></a></td>
		                </tr>
		                <?php } ?>
		              <?php } else { ?>
		                <tr>
		                  <td colspan="4" class="text-center text-info"><?php echo lang('Error.error_no_data_found', array(), $lang->getBackEndLocale()); ?></td>
		                </tr>
		              <?php } ?>
		            </tbody>
		          </table>
