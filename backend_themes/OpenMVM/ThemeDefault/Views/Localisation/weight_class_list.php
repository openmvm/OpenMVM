...
<div id="content-wrapper" class="content-wrapper min-vh-100">
  ...
  <!-- /.heading-container -->
    ...
    <?php echo form_open(base_url($_SERVER['app.adminDir'] . '/localisation/weight_classes/' . $administrator_token)); ?>
    <div class="clearfix mb-3">
	    <div class="float-end">
	      <a href="<?php echo base_url($_SERVER['app.adminDir'] . '/localisation/weight_classes/add/' . $administrator_token); ?>" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.button_add', array(), $lang->getBackEndLocale()); ?>"><i class="fas fa-plus"></i></a>
		  ...
		  <div class="accordion-item">
		    <h2 class="accordion-header" id="headingAdministratorGroup">
		      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAdministratorGroup" aria-expanded="true" aria-controls="collapseAdministratorGroup">
		        <i class="fas fa-weight-hanging fa-fw"></i>&nbsp;&nbsp;<?php echo lang('Heading.heading_weight_classes', array(), $lang->getBackEndLocale()); ?>
		      </button>
		    </h2>
		      ...
		      <div class="accordion-body">
		        <div class="table-responsive">
		          <table class="table table-hover">
		            <caption class="small"><?php echo lang('Caption.caption_list_of_weight_classes', array(), $lang->getBackEndLocale()); ?></caption>
		            <thead>
		              <tr>
		            ...
		            <tbody>
		              <?php if ($weight_classes) { ?>
		                ...
		                <tr>
		                  <th scope="row">
		                    <?php if (in_array($weight_class['weight_class_id'], $selected)) { ?>
		                  ...
		                  <td><a href="<?php echo $weight_class['edit']; ?>" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="<?php echo lang('Button.button_edit', array(), $lang->getBackEndLocale()); ?>"><i class="fa fa-edit"></i></a></td>
		                </tr>
		                <?php } ?>
		              <?php } else { ?>
		                <tr>
