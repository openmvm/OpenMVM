  ...
  <!-- /.heading-container -->
    ...
    <div class="clearfix mb-3">
	    <div class="float-end">
	      ...
	      <a href="<?php echo base_url($_SERVER['app.adminDir'] . '/localisation/cities/' . $administrator_token); ?>" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('Button.button_cancel', array(), $lang->getBackEndLocale()); ?>"><i class="fas fa-long-arrow-alt-left"></i></a>
	    </div>
    </div>
		  ...
		  <div class="accordion-item">
		    ...
		    <div id="collapseAdministratorGroup" class="accordion-collapse collapse show" aria-labelledby="headingAdministratorGroup" data-bs-parent="#accordionAdministratorGroup">
		      <div class="accordion-body">
		        ...
		        <div class="tab-content mt-3" id="cityTabContent">
