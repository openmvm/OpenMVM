		  ...
		  <div class="accordion-item">
		    <h2 class="accordion-header" id="headingSetting">
		      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSetting" aria-expanded="true" aria-controls="collapseSetting">
		        <i class="fas fa-edit fa-fw"></i>&nbsp;&nbsp;<?php echo lang('Heading.heading_theme_example_settings', array(), $lang->getBackEndLocale()); ?>
		      </button>
		    </h2>
						...
						<div class="tab-content" id="myTabContent">
						  <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
						  	...
						  	<div class="form-floating mb-3">
								  <input type="text" name="frontend_theme_example_example_name" value="<?php echo $frontend_theme_example_example_name; ?>" class="form-control<?php if ($validation->hasError('frontend_theme_example_example_name')) { ?> is-invalid<?php } ?>" id="input-name" placeholder="<?php echo lang('Entry.entry_name', array(), $lang->getBackEndLocale()); ?>">
								  <label for="input-name"><?php echo lang('Entry.entry_name', array(), $lang->getBackEndLocale()); ?></label>
								  <?php if ($validation->hasError('frontend_theme_example_example_name')) { ?>
                  <div class="text-danger small"><?php echo $validation->getError('frontend_theme_example_example_name'); ?></div>
                	<?php } ?>
								</div>
						  </div>
						</div>
