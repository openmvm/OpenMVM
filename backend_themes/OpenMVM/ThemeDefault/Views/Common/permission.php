...
<div id="content-wrapper" class="content-wrapper min-vh-100">
	...
	<section class="heading-container bg-dark p-3">
		<h2 class="heading-title text-white"><i class="fas fa-exclamation-triangle fa-fw"></i> <?php echo $heading_title; ?></h2>
  ...
  <!-- /.heading-container -->
	...
	<section class="content px-3">
		<h1 class="text-center text-danger">403 <?php echo lang('Text.text_forbidden', array(), $lang->getBackEndLocale()); ?></h1>
		<div class="text-center text-danger"><?php echo lang('Error.error_permission_access', array(), $lang->getBackEndLocale()); ?></div>
	</section>
  <!-- /.content -->
<?php echo $footer; ?>
