		  ...
		  <div class="accordion-item">
		    <h2 class="accordion-header" id="headingSetting">
		      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSetting" aria-expanded="true" aria-controls="collapseSetting">
		        <i class="fas fa-edit fa-fw"></i>&nbsp;&nbsp;<?php echo lang('Heading.heading_latest', array(), $lang->getBackEndLocale()); ?>
		      </button>
		    </h2>
		      ...
		      <div class="accordion-body">
                  ...
                  <div class="text-danger small"><?php echo $validation->getError('name'); ?></div>
                	<?php } ?>
						  	...
						  	<div class="form-floating mb-3">
								  <input type="number" min="1" name="limit" value="<?php echo $limit; ?>" class="form-control" id="input-limit" placeholder="<?php echo lang('Entry.entry_limit', array(), $lang->getBackEndLocale()); ?>">
								  <label for="input-limit"><?php echo lang('Entry.entry_limit', array(), $lang->getBackEndLocale()); ?></label>
								</div>
								<div class="form-floating mb-3">
