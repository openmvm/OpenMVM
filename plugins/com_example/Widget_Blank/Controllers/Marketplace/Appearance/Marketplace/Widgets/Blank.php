...
namespace Plugins\com_example\Widget_Blank\Controllers\Marketplace\Appearance\Marketplace\Widgets;
...
class Blank extends \App\Controllers\BaseController
{
    ...
    public function index($widget_id)
    {
        ...
        if ($widget_info) {
            ...
            return $this->template->render('Plugins', 'com_example', 'Widget_Blank', 'Marketplace\Appearance\Marketplace\Widgets\blank', $data);
        }
    }
}
